...
@section('content')
    ...
    <div class="col-lg-9 col-12">
                    <h3> تعديل المنشور ({{ $post->title }})</h3>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('title',
                         old('title', $post->title), ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::textarea('description',
                         old('description', $post->description), ['class' => 'form-control summernote']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            {!! Form::select('comment_able', ['1' => 'Yes', '0' => 'No'],
                             old('comment_able', $post->comment_able), ['class' => 'form-control']) !!}
                        ...
                        <div class="col-4">
                            ...
                            old('status', $post->status), ['class' => 'form-control']) !!}
                        ...
                        <div class="col-4">
                            ...
                            {!! Form::select('category_id', ['' => '---'] + $categories->toArray(),
                              old('category_id', $post->category_id), ['class' => 'form-control']) !!}
        ...
        $(function () {
            ...
            $('#post-images').fileinput({
                ...
                initialPreviewConfig: [
                    @if($post->media->count() > 0)
                        @foreach($post->media as $media)
                        {caption: "{{ $media->file_name }}", size: {{ $media->file_size }}, width: "120px", url: "{{ route('post.image.destroy', [$media->id, '_token' => csrf_token()]) }}", key: "{{ $media->id }}"},
                        @endforeach
                    @endif
                ],
            })
