...
<head>
    ...
    <meta name="description" content="sham">
<!-- Favicons -->
...
<?php
    $margue="<p >"."  موقع شام لبيع وشراء المنتجات سنعمل علي زيادة ظهور مؤسستك عبر الانترنت وجذب الزوار إلى موقع الويب الخاص بك  "."</p>";
...
<section class=" bar" id="bar" >
  ...
  <div class="alert  alert-dismissible fade show adalert " role="alert" >      
  
  
  <strong class="ad">|الإعلانات </strong>
  
  
  <marquee class="mar" direction="right" Scrollamount="4" >
  <p >  موقع شام لبيع وشراء المنتجات سنعمل علي زيادة ظهور مؤسستك عبر الانترنت وجذب الزوار إلى موقع الويب الخاص بك </p>       </marquee>
